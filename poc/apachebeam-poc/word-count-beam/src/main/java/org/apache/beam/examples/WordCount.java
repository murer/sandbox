...
public class WordCount {
	...
	public static void main(String[] args) {
		Set<Class<? extends PipelineOptions>> x = PipelineOptionsFactory.getRegisteredOptions();
		for (Class<? extends PipelineOptions> class1 : x) {
			System.out.println("x: " + class1);
		}
		...
		p.apply("ReadLines", TextIO.read().from(options.getInputFile())).apply(new CountWords())
